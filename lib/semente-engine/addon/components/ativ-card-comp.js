...
competencias: [
    ...
    {"idx": "6", "nome": "Modulação da tristeza"},
    {"idx": "7", "nome": "Modulação do medo"},
    {"idx": "8", "nome": "Modulação da raiva"},
    ...
    value: Ember.computed('data','appstate.upState', function() {
        ...
        console.log(this.get('instituicao'));
        ...
        if (aula) {
            ...
            matriculas.forEach(mat => {
                debugger; //matricula vindo sem propriedades
