...
export default Ember.Component.extend({
    ...
    actions: {
        refreshSelectedSegmento(selectedSegmentoId) {
            ...
            if(segmento.get('idx') == 3 || segmento.get('idx') == 4) this.set('hasEssencial', true);
            else this.set('hasEssencial', false);
            this.set('selectedEssencial', false);
        },
        ...
        essencialChanged(){
            var check = document.getElementById('checkbox-essencial').checked;
            this.set('selectedEssencial', check);
        }
    }
});
