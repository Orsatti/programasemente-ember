...
export default Ember.Component.extend({
    ...
    startInformation: Ember.computed('model',function(){
        if(this.get('changeset.id')){
            ...
            this.set('new_user_comprouAp', pessoa.get('comprouAp'));
            ...
            if(this.get('instituicao').get('csEnabled')){
                ...
                this.set('new_user_comprouAp', false);
            } 
    ...
    afterRenderInformation: Ember.computed('model',function(){
        if(this.get('changeset.id')){
            ...
            if(this.get('instituicao').get('csEnabled')){
                ...
                document.getElementById('new_user_comprouAp').checked = false;
                if (pessoa.get('comprouAp')) document.getElementById('new_user_comprouAp').checked = true;
            }
