...
export default Ember.Controller.extend({
  ...
  //tosqueira d mais, mas é provisório
  hasVendaDireta: Ember.computed('model', function () {
    var id = this.get('InstituicaoId');
    if (id == 22 || id == 212 || id == 201 || id == 205) {
        return true;
    }
    return false;
  }),
  ...
  actions: {
    ...
    supportMailer() {
      ...
      let params = JSON.stringify({
        "data": {
          ...
          "id": "0",
          "attributes": {
            "email-origem": "no-reply@sementeeducacao.com.br",
            "email-destino": "relacionamento@sementeeducacao.com.br",
    ...
    closeWarn() {
      ...
      maintenanceNotice.style.display = "none"; // Oculta o aviso
        // Define o cookie "maintenance-notice-closed" para evitar a exibição futura
        Cookies.set("maintenance-notice-closed", "true", { expires: 1 }); // Expira em 1 dia
    },
  }
});
