...
export default Controller.extend({
  ...
  acompanhamentoAtividades: Ember.observer('instituicao_id', function () {
    let that  = this;
    this.get('store').query('acompanhamento-atividade-instituicao', {
      instituicaoId: this.get('inst_selected').get('id'),
      plataformaAnoId: this.get('selected_ano_id'),
      plataformaTurmaId: this.get('selected_turma_id'),
      perfil: "aluno",
    }).then(function(response) {
      that.set('acompanhamentosAtividadesL',response);
  });
  }).property('inst_selected', 'selected_ano_id', 'selected_turma_id'),
