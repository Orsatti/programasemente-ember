...
export default Controller.extend({
  ...
  plataformaTurmas: Ember.computed('model', function () {
    // let inst = this.get('parentController.inst_selected');
    // let platTurmas = inst.get('plataformaTurmas');
    // let segmento = this.get('parentController').get('selectedSegmentoLocal.id');
    // debugger;
    // platTurmas.forEach(function (pt){
    //   let platTurma = this.get('store').peekRecord('plataforma-turma', pt.get('id'));
