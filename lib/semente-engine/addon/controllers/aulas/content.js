...
export default Controller.extend({
  ...
  conteudos: Ember.computed('aula', function(){
    ...
    if (['gestor', 'coordenador'].includes(localStorage.getItem('toggleRole'))){
      return conts.filterBy('situacao', true).filterBy('agrupamento.name', this.get('selectedAgrupamento'));
    }
     return conts.filter(c => c.get('publicos').mapBy('name').includes(localStorage.getItem('toggleRole'))).filterBy('situacao', true).filterBy('agrupamento.name', this.get('selectedAgrupamento'))
