...
export default Controller.extend({
  ...
  selectedSegmento: Ember.computed('model', function () {
    return this.get('parentController').get('selectedSegmento')
  }),

  plataformaAnos: Ember.computed('model', function () {
    return this.get('parentController').get('plataformaAnos')
  }),
  ...
  dependentes: Ember.computed('model', function () {
    let dependentes = [];
    let deps = this.get('pessoa').get('dependentes.firstObject');
    deps.forEach(p => {
  ...
  aulasFiltradas: Ember.computed('model', function () {
    this.set('search', document.getElementById('aulapesquisa').value);
      return this.get('plataformaAnos').filterBy('name', this.get('selectedAno')).get('firstObject.aulas').sortBy('idx');
  }),
