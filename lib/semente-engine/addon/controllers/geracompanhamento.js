...
export default Controller.extend({
  ...
  actions: {
    ...
    selectInst(id){
      let that = this;
      this.get('store').findRecord('instituicao', id, {include: 'plataforma-turmas.plataforma-ano, plataforma-anos.segmento', reload: true}).then(function (){
        that.transitionToRoute('acompanhamento.plataforma', id);
      });
    },
  }
})
