...
export default Controller.extend({
   ...
   actions: {
      ...
      closeModal(type) {
         ...
         if(type == "edit"){
            document.getElementById('edit_turma_modal').classList.remove('modal--is-show');
         }
