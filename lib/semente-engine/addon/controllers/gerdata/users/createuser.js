    ...
    save: function(changeset){
      ...
      changeset.validate().then(() => {
          if (changeset.get("isValid")) {
            ...
            if(changeset.get('role') != 'aluno' && document.getElementById('new_user_birth').value == ""){
              return $("#nascimento-error").html('Obrigatório');
            }
            ...
            if(changeset.get('role') == 'aluno'){
              ...
              if(document.getElementById('new_user_birth').value == "" && platAno.get('segmento').get('titulo') == "EJA"){
                return $("#nascimento-error").html('Obrigatório para alunos EJA'); 
              }
              if(document.getElementById('new_user_birth').value == "" && platAno.get('segmento').get('titulo') == "Adultos"){
                return $("#nascimento-error").html('Obrigatório para adultos'); 
              } 
