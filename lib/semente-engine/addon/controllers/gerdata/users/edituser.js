          ...
          if (changeset.get("isValid")) {
            ...
            if(changeset.get('role') == 'aluno'){
              ...
              if(changeset.get('enabled')){
                ...
                if(platAnosPortal.filter((value) => platAnosPortal.mapBy('id').indexOf(value.get('id')) == platAno.get('id')).length == 0){
              ...
              if(changeset.get('acessoPlataformaS')){
                ...
                if(platAnosS.filter((value) => platAnosS.mapBy('id').indexOf(value.get('id')) == platAno.get('id')).length == 0){
