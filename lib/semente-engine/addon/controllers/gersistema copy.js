...
export default Controller.extend({
  ...
  oneInst: Ember.computed('model', 'pessoaLogged', function () {
  ...
  selectedInstTabs: Ember.computed('inst_selected', function () {
    if ((pessoaLogged.get("role") == "secretaria") || (pessoaLogged.get("role") == "marketing")) {
      return {
        informations: false,
        courses: false,
        areas: true,
    ...
    if ((pessoaLogged.get("role") == "gestor") || (pessoaLogged.get("role") == "recursosHumanos")) {
      return {
        informations: false,
        courses: false,
        areas: false,
    ...
    if ((pessoaLogged.get("role") == "admin")) {
      return {
        informations: true,
        courses: false,
        areas: false,
  ...
  redirectToTurmas: Ember.computed(function () {
    if (pessoaLogged.get('role') == 'secretaria' || pessoaLogged.get('role') == 'gestor'|| pessoaLogged.get('role') == 'recursosHumanos') {
