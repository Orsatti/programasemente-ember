...
export default Controller.extend({
  ...
  codigosCadastros: Ember.computed('model',function(){
    this.get('store').findRecord('instituicao', this.get('inst_selected').get('id'), {include: 'codigos-cadastro'});
    return  this.get('inst_selected').get('codigosCadastro')
  }),

  codigosCadastrosAlunos: Ember.computed('model',function(){
    debugger;
    this.get('store').findRecord('instituicao', this.get('inst_selected').get('id'), {include: 'codigos-cadastro'});
  ...
  codigosCadastrosProfessores: Ember.computed('model',function(){
    this.get('store').findRecord('instituicao', this.get('inst_selected').get('id'), {include: 'codigos-cadastro'});
    let codigos = this.get('inst_selected').get('codigosCadastro')
    let arrayCodigos = codigos.toArray();
