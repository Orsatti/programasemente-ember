...
//------------------------------------------------------------------------------------------------------
  ...
  refreshAcessoS(){
    ...
    if(id != "" && id != "0"){
      ...
      if(!(platAno.get('idx') > 5 && platAno.get('idx') < 13 || platAno.get('idx') == 20)){
  ...
  actions: {
    ...
    userSave(param) {
      if (this.validateUserForm()) {
        ...
        let acessoS = document.getElementById('new_user_acessoPlataformaS').checked;
        ...
        if (param) {
          ...
          if (pessoa.get('acessoPlataformaS') !== acessoS) {
